  ...
  return (
    <>
      <header className="h-16 flex items-center justify-center relative">
          ...
          <div className="w-full mx-auto px-6">
            <div className="flex items-center justify-between relative ">
              ...
              <nav className="hidden md:flex items-center space-x-8">
                ...
                <Link to="/board" className="text-gray-500 dark:text-gray-400 text-sm hover:text-indigo-500 dark:hover:text-indigo-400">
                  Board
                </Link>
        ...
        <div
          id="mobileMenu"
          className={`absolute top-full w-full px-6 ${mobileMenuOn ? "translate-y-0" : "-translate-y-full"} transition-transform duration-300 z-50`}>
